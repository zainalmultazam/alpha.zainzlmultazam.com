...
ssh -p 65002 -i ~/.ssh/cpanel_deploy_key -o StrictHostKeyChecking=no pedulyco@109.106.253.21 "cd /home/pedulyco/public_html/alpha.zainalmultazam.com && bash start_server.sh"
